...
class ConsentType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->addEventListener(FormEvents::POST_SUBMIT, [$this, 'updateDenormalizedDefaultName']);
    }

    /**
     * We must use this event listener, because `LocalizedFallbackValueCollectionType`
     * updates localization value through event listeners and data transformation
     * without triggering any events on Consent entity.
     *
     * @param FormEvent $event
     */
    public function updateDenormalizedDefaultName(FormEvent $event)
    {
        $consent = $event->getData();
        if ($consent instanceof Consent) {
            $consent->updateDenormalizedDefaultName();
        }
    }
